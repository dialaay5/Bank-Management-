...
public class BankLeomi extends Bank {
    ...
    public BankLeomi(int id, EnumBankName enumBankName, int number_of_employees, double amount_of_revenue, double amount_of_expenses) {
    ...
    public double calculate_Customer_Money() {
        ...
        setAmount_of_revenue(this.amount_of_revenue - sum_of_customers_money);
